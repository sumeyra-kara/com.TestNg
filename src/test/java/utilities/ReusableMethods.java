...
public class ReusableMethods {
    ...
    public static void tumSayfaFotografCek(WebDriver driver){
        ...
        String tarihEtiketi = "TumSayfa"+ldt.getYear()+ldt.getMonthValue()+ldt.getDayOfMonth()+ldt.getHour()+ldt.getMinute()+ldt.getSecond()+".png";
    ...
    public static void webElementFotografCek(WebDriver driver, WebElement webElement) {
        LocalDateTime ldt = LocalDateTime.now();
        String tarihEtiketi = "WebElement"+ldt.getYear()+ldt.getMonthValue()+ldt.getDayOfMonth()+ldt.getHour()+ldt.getMinute()+ldt.getSecond()+".png";
        String path="target/ekranResimleri/"+tarihEtiketi;
        File tumSayfaFotograf =new File(path);
     ...
     * @param targetTitle
     */
    public static void switchToWindow(String targetTitle) { //------Switching Window-----//
     ...
     */
    public static void hover(WebElement element) { //------Hover Over------//
